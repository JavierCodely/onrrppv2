-- =============================================
-- Migration: 030 - Add Grupos to Personal and Lotes
-- Description: Sistema de grupos (A, B, C, D) para organización de RRPPs y lotes
-- Dependencies: 003_create_personal.sql, update/002_create_lotes.sql
-- =============================================
...
ADD COLUMN grupo grupo_type;

-- Crear índice para mejorar performance de queries por grupo
CREATE INDEX idx_personal_grupo ON public.personal(grupo);
CREATE INDEX idx_personal_rol_grupo ON public.personal(rol, grupo);
...
CREATE INDEX idx_lotes_grupo ON public.lotes(grupo);
CREATE INDEX idx_lotes_evento_grupo ON public.lotes(uuid_evento, grupo);
