-- =============================================
-- Migration: 031 - Add Fecha Nacimiento and Admin Update Policy
-- Description: Agregar campo fecha_nacimiento a personal, calcular edad automáticamente y política para que admins puedan editar empleados
-- Dependencies: 003_create_personal.sql, 007_create_rls_policies.sql
-- =============================================
...
-- ========================================
-- STEP 2: Add RLS Policy for Admins to update other personal
-- ========================================
...
'Los admins pueden actualizar nombre, apellido, edad, sexo, grupo, activo y fecha_cumpleanos de empleados de su club';
...
-- La edad se calculará automáticamente (34 años en 2024)

-- Para recalcular edad de usuarios existentes que ya tienen edad manual:
-- UPDATE public.personal SET fecha_nacimiento = CURRENT_DATE - (edad || ' years')::INTERVAL WHERE edad IS NOT NULL AND fecha_nacimiento IS NULL;
