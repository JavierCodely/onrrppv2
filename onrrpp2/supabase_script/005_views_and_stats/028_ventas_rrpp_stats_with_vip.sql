-- =============================================
-- Migration: 028 - Update Ventas RRPP Stats with VIP
-- Description: Ensure ventas_rrpp_stats view includes lote_es_vip field
-- Dependencies: 027_add_comision_rrpp_to_lotes.sql
-- Version: 1.0 (Consolidated from 029_update_ventas_rrpp_stats_add_vip.sql)
-- Note: This resolves duplicate 029 numbering issue
-- =============================================

-- Drop and recreate the view with explicit VIP field
...
SELECT
    ...
    l.es_vip as lote_es_vip,  -- Explicitly include VIP flag
    l.comision_tipo,
