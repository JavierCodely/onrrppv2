...
CREATE INDEX IF NOT EXISTS idx_invitados_qr_code ON public.invitados(qr_code);
...
COMMENT ON FUNCTION generate_unique_qr_code IS 'Genera un código QR único de 12 caracteres alfanuméricos';
...
COMMENT ON FUNCTION set_invitado_qr_code IS 'Trigger function para generar QR code automáticamente al insertar invitado';
