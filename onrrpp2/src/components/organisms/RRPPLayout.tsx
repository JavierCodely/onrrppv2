  ...
  const SidebarContent = () => (
    <>
      <div className="p-6 border-b border-slate-200 dark:border-slate-800">
        <h1 className="text-xl font-bold">Panel RRPP</h1>
        <Badge className="mt-2 bg-blue-500">RRPP</Badge>
      </div>
      ...
      <div className="flex h-screen">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <header className="md:hidden sticky top-0 z-10 flex items-center gap-4 border-b bg-white dark:bg-card px-4 py-3">
            ...
            <h1 className="font-semibold">Panel RRPP</h1>
          </header>
